...
class DataInspectionTool(BaseTool):
    ...
    description = "Inspect the structure and statistics of wafer data. Use this to understand the dataset."
...
class ClusteringTool(BaseTool):
    ...
    name = "apply_clustering"
    description = """Apply a clustering algorithm to wafer data. 
...
class ClusterAnalysisTool(BaseTool):
    ...
    description = "Analyze the characteristics of clusters including yield, defects, and other parameters. No input required."
...
class OptimalClustersTool(BaseTool):
    ...
    description = "Find the optimal number of clusters using elbow method and silhouette analysis. Input: max_clusters (optional, default=10)"
...
class VisualizationTool(BaseTool):
    ...
    description = """Create visualizations of clustering results. 
